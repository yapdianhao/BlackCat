...
exports.dateIsLater = exports.dateIsWithinMonth = exports.dateIsWithinWeek = exports.dateIsTomorrow = exports.dateIsToday = void 0;
...
var dateIsLater = function (inputDate) {
    var today = new Date();
    var date1UTC = Date.UTC(today.getFullYear(), today.getMonth(), today.getDate());
    var date2UTC = Date.UTC(inputDate.getFullYear(), inputDate.getMonth(), inputDate.getDate());
    var daysConverter = 1000 * 3600 * 24;
    return ((date2UTC - date1UTC) / daysConverter > 0 ||
        ((date2UTC - date1UTC) / daysConverter === 0 &&
            today.getHours() < inputDate.getHours()));
};
exports.dateIsLater = dateIsLater;
